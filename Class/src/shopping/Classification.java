...
public class Classification { //分类类，缩写为Clas。
    ...
    public Commodity getCommByID(String CommID) //给定一个商品ID，返回该分类下这个商品的引用。
    {
    ...
    public boolean deleteCommByID(String CommID) //给定一个商品ID，删除该分类下该商品引用。仅删除引用（即包含关系），不会删除商品本身。
    {
